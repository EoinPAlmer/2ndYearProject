...
insert into user (email,role,name,password) values ('finn@sneakersan.com','admin','FinnHarvey','finn');
insert into user (email,role,name,password) values ('eoin@sneakersan.com','admin','EoinPalmer','eoin');
insert into user (email,role,name,password) values ('paul@sneakersan.com','admin','PaulRoche','paul');
