                ...
                """),_display_(/*47.18*/for(p <- products) yield /*47.36*/ {_display_(Seq[Any](format.raw/*47.38*/("""
                    """),format.raw/*48.21*/("""<div class="col-sm-6 col-md-4 col-xs-6 col-lg-4 products">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                    <img src="/assets/images/productImages/"""),_display_(/*52.77*/(p.getId + ".jpg")),format.raw/*52.95*/("""" alt="..." height="270" width="300">
...
"""),format.raw/*102.1*/("""</div>
 """))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Tue Apr 23 15:40:48 IST 2019
                  SOURCE: /home/wdd/2ndYearProject/app/views/onsale.scala.html
                  HASH: 4aefbbadc4dc590db6600ca0581584ad5bee321d
