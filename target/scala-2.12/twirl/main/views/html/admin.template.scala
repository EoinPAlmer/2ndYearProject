...
<script>
    ...
    function confirmDel()"""),format.raw/*62.26*/("""{"""),format.raw/*62.27*/("""
        """),format.raw/*63.9*/("""return confirm('Are you sure?');
    """),format.raw/*64.5*/("""}"""),format.raw/*64.6*/("""

        """),format.raw/*66.9*/("""$(document).ready(function () """),format.raw/*66.39*/("""{"""),format.raw/*66.40*/("""

            """),format.raw/*68.13*/("""var docHeight = $(window).height();
            var footerHeight = $('#footer').height();
            var footerTop = $('#footer').position().top + footerHeight;

            if (footerTop < docHeight) """),format.raw/*72.40*/("""{"""),format.raw/*72.41*/("""
                """),format.raw/*73.17*/("""$('#footer').css('margin-top', 350 + (docHeight - footerTop) + 'px');
