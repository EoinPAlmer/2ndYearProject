			...
			<tbody>
                """),_display_(/*42.18*/if(customer.getBasket() != null)/*42.50*/ {_display_(Seq[Any](format.raw/*42.52*/("""
                    ...
                    """),format.raw/*45.21*/("""<tr>
                        ...
                        <td><a href=""""),_display_(/*51.39*/routes/*51.45*/.ShoppingCtrl.removeOne(i.getId, i.getProduct.getId)),format.raw/*51.97*/(""""><span class = "btn btn-sm btn-danger"><span class="glyphicon glyphicon-minus-sign"></span></a></td>
                        <td><a href=""""),_display_(/*52.39*/routes/*52.45*/.ShoppingCtrl.addOne(i.getId, i.getProduct.getId)),format.raw/*52.94*/(""""><span class = "btn btn-sm btn-danger"><span class="glyphicon glyphicon-plus-sign"></span></a></td>
                    </tr>
    ...
    """),format.raw/*90.5*/("""}"""),format.raw/*90.6*/("""
        ...
        """),format.raw/*92.9*/("""$(document).ready(function () """),format.raw/*92.39*/("""{"""),format.raw/*92.40*/("""
            ...
            if (footerTop < docHeight) """),format.raw/*98.40*/("""{"""),format.raw/*98.41*/("""
                """),format.raw/*99.17*/("""$('#footer').css('margin-top', 570 + (docHeight - footerTop) + 'px');
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Wed Apr 24 15:15:04 IST 2019
                  SOURCE: /home/wdd/2ndYearProject/app/views/basket.scala.html
                  HASH: 278a6f7f0ccf96512b86524fee94ccd43b3bdb86
                  MATRIX: 964->1|1070->38|1106->68|1138->94|1191->35|1219->119|1246->120|1317->166|1358->199|1397->201|1427->204|1510->260|1549->290|1589->292|1634->309|1716->364|1730->369|1764->382|1809->399|1856->415|1886->418|1939->445|1980->477|2020->479|2053->485|2124->529|2138->534|2174->549|2207->555|2247->565|2289->579|2654->917|2695->949|2735->951|2784->972|2894->1055|2960->1105|3000->1107|3049->1128|3110->1162|3120->1163|3160->1182|3222->1217|3232->1218|3275->1240|3344->1282|3392->1309|3461->1351|3516->1385|3578->1420|3588->1421|3630->1442|3701->1486|3716->1492|3789->1544|3956->1684|3971->1690|4041->1739|4220->1887|4291->1927|4322->1931|4499->2081|4571->2131|4778->2311|4793->2317|4841->2344|5163->2639|5178->2645|5225->2671|5558->2976|5587->2977|5617->2980|5678->3014|5706->3015|5734->3016|5808->3062|5837->3063|5873->3072|5937->3109|5965->3110|6002->3120|6060->3150|6089->3151|6131->3165|6361->3367|6390->3368|6435->3385|6546->3467|6576->3468|6613->3477|6643->3478
